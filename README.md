...
Para ello recuerde  que puede hacer uso, bien sea, de las tablas de verdad o de la descripci髇 algor憝tmica del BCD a  siete segmentos. Recuerde que cada Segmento es una salida  del dise帽o. Ejemplo, si desea  visualizar el n煤mero **1**, la salida seria  de `Sseg es 0110000`. observe la gr谩fica a continuaci贸n, para generar las salidas acorde al n煤mero de entrada.
